...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-Crwfnx-2.js')),
			__memo(() => import('./chunks/1-Bi9x1TWo.js')),
			__memo(() => import('./chunks/2-BkpnPtd1.js')),
			__memo(() => import('./chunks/3-8-IixwAW.js')),
			__memo(() => import('./chunks/4-BUZhATn6.js')),
			__memo(() => import('./chunks/5-BoqUDoeA.js')),
			__memo(() => import('./chunks/6-DjWUzPWh.js')),
			__memo(() => import('./chunks/7-DJh8udBC.js'))
		],
		remotes: {
